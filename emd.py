...
if 'french'=="greek": # There is an issue with \sigma in the embeddings. Greeks have different sigma symbol in the word or in the end
...
######################################################################################
#print ("Starting experiments with WMD - tfidf: Retrieve English documents, given queries in %s"% 'french')
